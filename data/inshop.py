...
if __name__ == '__main__':
    ...
    for i in random.sample(list(range(0,len(inshop_train_set))), 5):
    ...
    for i in random.sample(list(range(0,len(inshop_query_set))), 5):
    ...
    for i in random.sample(list(range(0,len(inshop_index_set))), 5):
